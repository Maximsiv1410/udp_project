...
namespace net {
	namespace sip {
		...
		public:
			...
			response &  set_version(const std::string & version) { version_ = /*std::move(*/version/*)*/; return *this; }
			...
			response & set_status(const std::string & status) { status_ = /*std::move(*/status/*)*/; return *this; }
		...
		public:
			...
			request &  set_method(std::string & meth) { method_ = /*std::move(*/meth/*)*/;  return *this; }
